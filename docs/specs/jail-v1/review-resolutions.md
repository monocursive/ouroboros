...
| Test seams live in the release binary | Kept and recorded: the tested binary is the shipped binary. J5 adds `OURO_JAIL_TEST_ARCH`, `OURO_JAIL_TEST_MOUNT_SWAP`, `OURO_JAIL_TEST_TRACER_TRUNCATE_PATH` and `OURO_JAIL_TEST_TRACER_UNMATCHED_EXIT` | §6.2 |
