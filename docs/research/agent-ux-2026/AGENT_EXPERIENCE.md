...
| 22 | Install / update / auth | 1 | 1 (the signed self-update and the installer were deleted with the distribution lane, `proposals/core.md` §3 D4; `make ouro` builds the binary and an operator copies it; auth unchanged) |
