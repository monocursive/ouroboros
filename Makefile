...
# The pre-J2 and pre-J3 corpora exercise retired session and core structs under both loading modes.
boot-gate:
	...
	sh scripts/fixture/j3_boot_gate.sh
	MIX_ENV=dev $(MIX) run --no-start scripts/check_runtime_graph.exs
