//! forge-fixture — an ouroboros capability, in the world `ouroboros:capability@0.1.0`.
//!
//! Build it:
//!
//! ```text
...
//! ```
//!
//! The component is `target/wasm32-wasip2/release/forge_fixture.wasm`. See README.md for what
//! to do with it.
//!
...
impl Capability for ForgeFixture {
    ...
    fn describe() -> Describe {
        Describe::new("forge-fixture", env!("CARGO_PKG_VERSION"))
            .summary("A capability forged from an agent, inside the fence.")
    ...
    fn init(_config: Value) -> Result<Self, String> {
        log("info", "forge-fixture ready");
        Ok(ForgeFixture { messages: 0 })
    }
...
export_capability!(ForgeFixture);
