...
The component is `target/wasm32-wasip2/release/forge_fixture.wasm`.
...
printf '{"jsonrpc":"2.0","id":1,"method":"inspect","params":{"path":"%s"}}\n' \
  "$PWD/target/wasm32-wasip2/release/forge_fixture.wasm" \
  | ouro-wasm serve
```
...
event = "PreToolUse"
matcher = "write|edit"
component = "./forge_fixture.wasm"
config = '{}'

[checks]
forge-fixture = { component = "./forge_fixture.wasm" }
```
