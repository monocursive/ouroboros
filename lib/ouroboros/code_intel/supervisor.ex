defmodule Ouroboros.CodeIntel.Supervisor do
  ...
  One instance runs on a `:core` node. Tests start their own under a different name so
  they can shorten idle windows and inject a memory reader without touching the node's.
  """
